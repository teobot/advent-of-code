...
// Task link -- https://adventofcode.com/2021/day/18
// Github link -- https://github.com/teobot/advent-of-code/tree/main/2021/task%2018
// Created by Theo Clapperton

const { inputToArray, tests } = require("../../common/common");

const _REALinput = inputToArray("../2021/task 18/input.txt", "\n");
const _TESTinput = inputToArray("../2021/task 18/test.txt", "\n");
