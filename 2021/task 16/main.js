...
// Task link -- https://adventofcode.com/2021/day/16
// Github link -- https://github.com/teobot/advent-of-code/tree/main/2021/task%2016
// Created by Theo Clapperton

const { inputToArray, tests } = require("../../common/common");

const _REALinput = inputToArray("../2021/task 16/input.txt", "\n");
const _TESTinput = inputToArray("../2021/task 16/test.txt", "\n");
