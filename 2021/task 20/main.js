...
// Task link -- https://adventofcode.com/2021/day/20
// Github link -- https://github.com/teobot/advent-of-code/tree/main/2021/task%2020
// Created by Theo Clapperton

const { inputToArray, tests } = require("../../common/common");

const _REALinput = inputToArray("../2021/task 20/input.txt", "\n");
const _TESTinput = inputToArray("../2021/task 20/test.txt", "\n");
